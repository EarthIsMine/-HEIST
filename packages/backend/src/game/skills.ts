import type { Player, Storage, Jail, SkillType } from '@heist/shared';
import {
  STEAL_RANGE,
  STEAL_RATE,
  BREAK_JAIL_RANGE,
...
export interface SkillEvent {
  type: 'skill_started' | 'skill_interrupted' | 'player_jailed' | 'player_freed' | 'storage_emptied' | 'cops_stunned';
